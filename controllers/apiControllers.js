function index(req, res) {
	res.json({
		...
		endpoints: [
			{
				method: 'GET', path: '/api', description: 'send back all characters as json',
				method: 'GET', path: '/api/characters', description: 'find one character by id and send it back as json',
